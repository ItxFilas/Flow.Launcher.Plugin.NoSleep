...
/// <summary>
/// Countdown timer for timed nosleep activation.
/// </summary>
internal class NoSleepTimer : IDisposable
{
    private Timer _timer;
    private readonly object _lock = new();

    /// <summary>
    /// The absolute time when nosleep will expire.
    /// </summary>
    ...
    public string FormatRemainingTime()
    {
        ...
        if (totalMinutes >= 60)
            return $"{totalMinutes / 60}h {totalMinutes % 60}m remaining";
