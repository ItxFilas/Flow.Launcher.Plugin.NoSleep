...
{
    /// <summary>
    /// Creates a new nosleep NotifyIcon with a fully populated context menu.
    /// </summary>
    ...
    /// <param name="onDisplayModeSelected">Callback when a display mode is clicked (true = keep display awake)</param>
    ...
    public static (NotifyIcon notifyIcon, ToolStripMenuItem statusItem) CreateNoSleepIcon(
        ...
        Action onTurnOff)
    {
        ...
        var statusItem = new ToolStripMenuItem("NoSleep is active") { Enabled = false };
        contextMenu.Items.Add(statusItem);
        contextMenu.Items.Add(new ToolStripSeparator());

        // Task.Run prevents deadlock when a callback hides the tray from the STA thread.
        ...
        contextMenu.Items.Add(new ToolStripSeparator());
        contextMenu.Items.Add(new ToolStripMenuItem("Keep Display On", null, (s, e) => Task.Run(() => onDisplayModeSelected(true))));
        contextMenu.Items.Add(new ToolStripMenuItem("Allow Display Sleep", null, (s, e) => Task.Run(() => onDisplayModeSelected(false))));

        contextMenu.Items.Add(new ToolStripSeparator());
        contextMenu.Items.Add(new ToolStripMenuItem("Turn Off", null, (s, e) => Task.Run(onTurnOff)));

        notifyIcon.Text = "NoSleep is active";
